class Backoffice::AdminsController < BackofficeController
  ...
  def edit
  	#@category está no before_action
  end
...
#Guardando o password e password_confirmation da nossa requisição
#pois está obrigando a inserir senha na edição.
#removemos a senha e confirmação do hash para que possamos editar sem precisar alterar senha
# caso a requisição da edição não venha com a senha(esteja vazia),
